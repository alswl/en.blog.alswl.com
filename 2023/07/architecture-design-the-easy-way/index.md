...
![arch-easy](https://en.blog.alswl.com/img/202307/arch-easy.png)
...
Let’s first clarify <mark>what architecture design and system analysis are</mark> (the latter often shortened to “system analysis”). Some of you are familiar with the first but not the second. No worries—here’s how Wikipedia introduces them:
...
Technical architecture can be split in two: one is <mark>top-down</mark>—business, strategy, and framework division; the other is <mark>focused on engineering and implementation (coding)</mark>.
...
![word-cloud-arch-biz](https://en.blog.alswl.com/img/202307/word-cloud-arch-biz.png)
...
![word-cloud-arch-impl](https://en.blog.alswl.com/img/202307/word-cloud-arch-impl.png)

<small>generated by https://tendcode.com/tool/word-cloud/</small>

Architecture is a broad topic. This article picks one angle: <mark>making architectural thinking useful in day-to-day work through practice and methodology, to cover about 80% of engineering design and development scenarios</mark>. I call this “architecture design the easy way.”
...
![Putting the elephant in the fridge](https://en.blog.alswl.com/img/202307/elephant.png)
...
![Problem — Agreement — Action](https://en.blog.alswl.com/img/202307/q-n-a.png)
...
![Prometheus architecture](https://en.blog.alswl.com/img/202307/prometheus-architecture.png)
...
What’s a good way to organize everything? I often use a <mark>subject–verb–object (and adjuncts)</mark> approach: who does what, in what scenario (optional), in what state (optional).

![Subject-verb-object](https://en.blog.alswl.com/img/202307/gramma.jpg)

<small>image via unknown</small>

Use cases break requirements down clearly, and you keep communicating with the stakeholders in the process.

<mark>Demo scripts are the product manager’s weapon; requirement use cases are the engineer’s weapon.</mark>
...
![Netease Cloud Music](https://en.blog.alswl.com/img/202307/netease-music.png)
...
![Kubernetes RBAC](https://en.blog.alswl.com/img/202307/rbac.png)
...
Kubernetes [Concepts](https://kubernetes.io/docs/concepts/)—dozens of subcategories and hundreds of concepts—show how complex such a system can be.
...
![Header-based API Gateway versioning with CloudFront](https://en.blog.alswl.com/img/202307/aws-seq.png)
